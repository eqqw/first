...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a class="btn btn-primary" href="/stu/downloadExcel">下载Excel模板</a>
			<form class="form-horizontal" id="form_table" action="/stu/import" enctype="multipart/form-data" method="post">
				<table>
					<tr>
						<td><input type="file" id="filename" name="filename" value="" /></td>
						<td><button type="submit" onclick="return uploadFile()">上传</button></td>
					</tr>
				</table>
			</form>
			...
			<table id="grid-data" class="table table-condensed ">
				...
				<tr>
					...
					<th data-column-id="stuName">名字</th>
					<th data-column-id="stuAge">年龄</th>
					<th data-column-id="stuMajor" data-order="desc">学院</th>
